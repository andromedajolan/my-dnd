...
ac: "14"
hp: "110 (20d6 + 40)"
speed: "walk 30 ft. in rat or hybrid form"
str: 12
dex: 18
con: 15
int: 17
...
### Traits
***Evasion.*** If Delour is subjected to an effect that allows him to make a Dexterity saving throw to take only half damage, he instead takes no damage if he succeeds on the saving throw and only half damage if he fails, provided he doesn't have the {@condition incapacitated} condition.
...
***Cunning Action.*** Delour takes the {@action Dash}, {@action Disengage}, or {@action Hide} action.
